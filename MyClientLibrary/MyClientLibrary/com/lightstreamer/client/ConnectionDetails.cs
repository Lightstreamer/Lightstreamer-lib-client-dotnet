...
namespace com.lightstreamer.client
{
    ...
    {
        //This class is just a proxy for the InternalConnectionDetails class (for visibility of the elements sake)

        private readonly InternalConnectionDetails @internal;
        ...
        public virtual string AdapterSet
        {
            ...
            set
            {
                lock (this)
                {
                    this.@internal.AdapterSet = value;
                }
            }
        }
        ...
        public virtual string ServerAddress
        {
            get
            {
                lock (this)
                {
                    return this.@internal.ServerAddress;
                }
            }
            set
            {
                lock (this)
                {
                    this.@internal.ServerAddress = value;
                }
            }
        }
        ...
        public virtual string ServerInstanceAddress
        {
            get
            {
                lock (this)
                {
                    return this.@internal.ServerInstanceAddress;
                }
            }
        }
        ...
        public virtual string ServerSocketName
        {
            get
            {
                lock (this)
                {
                    return this.@internal.ServerSocketName;
                }
            }
        }
        ...
        public virtual string SessionId
        {
            get
            {
                lock (this)
                {
                    return this.@internal.SessionId;
                }
            }
        }
