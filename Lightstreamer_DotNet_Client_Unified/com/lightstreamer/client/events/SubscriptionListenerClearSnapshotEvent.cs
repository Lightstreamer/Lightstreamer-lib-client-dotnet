...
{
    public class SubscriptionListenerClearSnapshotEvent : Event<SubscriptionListener>
    {
        private readonly int itemPos;
        private readonly string itemName;

        public SubscriptionListenerClearSnapshotEvent(string itemName, int itemPos)
        {
